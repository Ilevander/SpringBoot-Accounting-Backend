...
public class SecurityConstant {
    ...
    public static final String TOKEN_PREFIX = "Bearer "; //ownership of token without verifying , everyone can use the token to access to the application, since the token has bearer too
